...
# ============================================================
    ...
    # Reintenta con otra combinación de año/página si la primera no trajo nada,
    # porque géneros específicos en un año puntual pueden no tener 3 páginas de resultados.
