...
/* Botón de abrir/cerrar la sidebar: ícono de 3 líneas (hamburguesa) en vez de la flecha nativa.
   :not([kind]) evita tocar los botones del menú (Inicio, Buscar, etc.), que sí tienen kind.
   Se tapa el ícono original tanto si es un dibujo (svg) como si es texto de una fuente de íconos. */
[data-testid="stSidebarCollapsedControl"],
section[data-testid="stSidebar"] button:not([kind]),
header[data-testid="stHeader"] button:not([kind]) {
...
[data-testid="stSidebarCollapsedControl"] *,
section[data-testid="stSidebar"] button:not([kind]) svg,
section[data-testid="stSidebar"] button:not([kind]) *,
header[data-testid="stHeader"] button:not([kind]) svg,
header[data-testid="stHeader"] button:not([kind]) * {
    display: none !important;
}
[data-testid="stSidebarCollapsedControl"]::after,
section[data-testid="stSidebar"] button:not([kind])::after,
header[data-testid="stHeader"] button:not([kind])::after {
    content: "" !important;
    ...
    background: #e5e5e5;
    border-radius: 1px;
    box-shadow: 0 -6px 0 #e5e5e5, 0 6px 0 #e5e5e5;
